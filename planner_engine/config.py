...
DEFAULT_PLANNING_PREVIEW_DIR = DEFAULT_GOOGLE_CONFIG_DIR / "planning-previews"
DEFAULT_EXECUTION_SETTINGS_PATH = DEFAULT_GOOGLE_CONFIG_DIR / "execution-settings.json"
DEFAULT_EXTERNAL_LINKS_PATH = DEFAULT_GOOGLE_CONFIG_DIR / "external-links.json"
DEFAULT_EXECUTION_PREVIEW_DIR = DEFAULT_GOOGLE_CONFIG_DIR / "execution-previews"
DEFAULT_APPLE_CALENDAR_HELPER_PATH = (
    DEFAULT_GOOGLE_CONFIG_DIR
    / "bin"
    / "PlannerAppleCalendar.app"
    / "Contents"
    / "MacOS"
    / "planner-apple-calendar"
)
DEFAULT_DECISION_LOG_PATH = DEFAULT_GOOGLE_CONFIG_DIR / "decision-log.jsonl"
